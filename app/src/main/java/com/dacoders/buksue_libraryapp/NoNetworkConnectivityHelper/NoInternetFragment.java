package com.dacoders.buksue_libraryapp.NoNetworkConnectivityHelper;
...
public class NoInternetFragment extends Fragment {
    ...
    private TextView gotoDownloadsBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gotoDownloadsBtn = view.findViewById(R.id.proceedToDownloadsTextView);


        gotoDownloadsBtn.setOnClickListener(click->{
